    ...
    const fetchDashboardData = async () => {
      try {
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL || "http://127.0.0.1:8000/api"}/faculty/dashboard`,
          {
            headers: {
              Accept: "application/json",
              Authorization: `Bearer ${token}`,
    ...
    <main className="dashboard-container">
      <header className="dashboard-header">
        <div className="header-left">
          <div className="badge">FACULTY PORTAL</div>
          ...
          <div className="info-grid">
            <div className="card">
              ...
              <ul className="class-list">
                {data?.data.assigned_classes?.map((cls, idx) => (
            ...
            <div className="card action-card">
              ...
              <p>Review and edit profiles of enrolled students in your courses.</p>
